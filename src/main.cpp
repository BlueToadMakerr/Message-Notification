...
// Modify MenuLayer
class $modify(MessageChecker_MenuLayer, MenuLayer), public MessageCheckerBase {
public:
    bool init() {
...
            this->schedule(schedule_selector(MessageChecker_MenuLayer::onScheduledTick), 1.0f);
            onScheduledTick(0);
        } else {
...
// Modify PlayLayer
class $modify(MessageChecker_PlayLayer, PlayLayer), public MessageCheckerBase {
public:
    bool init() {
...
            this->schedule(schedule_selector(MessageChecker_PlayLayer::onScheduledTick), 1.0f);
            onScheduledTick(0);
        } else {
            log::info("boot already done, skipping init check and re-running the schedule");
            this->schedule(schedule_selector(MessageChecker_PlayLayer::onScheduledTick), 1.0f);
...
class $modify(MessageChecker_LevelEditorLayer, LevelEditorLayer), public MessageCheckerBase {
public:
    bool init() {
...
            this->schedule(schedule_selector(MessageChecker_LevelEditorLayer::onScheduledTick), 1.0f);
            onScheduledTick(0);
        } else {
            log::info("boot already done, skipping init check and re-running the schedule");
            this->schedule(schedule_selector(MessageChecker_LevelEditorLayer::onScheduledTick), 1.0f);

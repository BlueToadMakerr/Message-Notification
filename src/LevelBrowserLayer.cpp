...
class $modify(MessageChecker_LevelBrowser, LevelBrowserLayer) {
    struct Fields {
    ...
    void checkMessages() {
        ...
        req->setResponseCallback(this, SEL_HttpResponse(&MessageChecker_LevelBrowser::onMessageResponse));
    ...
    bool init(GJSearchObject* p0) {
        ...
        // NO bootChecked check or onScheduledTick(0), just reschedule every init
        log::info("re-running the schedule");
        this->schedule(schedule_selector(MessageChecker_LevelBrowser::onScheduledTick), 1.0f);
